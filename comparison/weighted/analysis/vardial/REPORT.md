...
- Teacher metadata: `results/metadata/vardial/teacher/run_metadata.json`
- Student metadata: `results/metadata/vardial/student/*/run_metadata.json`
...
- Best student: `kd_logit_attn` with test macro-F1 `0.6543`.
- CE-only student test macro-F1: `0.5702`.
- Student macro-F1 spread across conditions: `0.2810`.
- Mean final attention-loss magnitude: `0.65722`.

The best student is `kd_logit_attn` (test macro-F1 `0.6543`), but with a single seed the factorial effects
...
Source files:
`results/metadata/vardial/teacher/run_metadata.json` and
`results/metadata/vardial/student/*/run_metadata.json`
...
| `kd_logit_attn` | Y |  | Y | 0.6543 | +0.0840 | 0.6526 | 0.0470 | **0.7410** |
| `kd_attn` |  |  | Y | 0.6330 | +0.0627 | 0.6316 | 0.0786 | 0.7221 |
| `kd_full` | Y | Y | Y | 0.6136 | +0.0434 | 0.6168 | 0.0558 | 0.6884 |
| `kd_logit` | Y |  |  | 0.5969 | +0.0267 | 0.6000 | 0.0454 | 0.6421 |
| `ce_only` |  |  |  | 0.5702 | +0.0000 | 0.5726 | **0.0286** | 0.6337 |
| `kd_hidden_attn` |  | Y | Y | 0.5176 | -0.0526 | 0.5326 | 0.0391 | 0.6105 |
| `kd_logit_hidden` | Y | Y |  | 0.4878 | -0.0824 | 0.4947 | 0.0397 | 0.5221 |
| `kd_hidden` |  | Y |  | 0.3733 | -0.1969 | 0.4126 | 0.0371 | 0.4716 |

Best student test macro-F1 is `kd_logit_attn` at 0.6543, +0.0840 over `ce_only`.
...
|---|---:|---:|---:|
| `logit` | main | +0.06464 | 0.06464 |
| `hidden` | main | -0.11553 | 0.11553 |
| `attention` | main | +0.09755 | 0.09755 |
| `logit x hidden` | 2-way | +0.04062 | 0.04062 |
| `logit x attention` | 2-way | -0.00598 | 0.00598 |
| `hidden x attention` | 2-way | +0.03752 | 0.03752 |
| `logit x hidden x attention` | 3-way | -0.00326 | 0.00326 |
